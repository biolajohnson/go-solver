...
def write_move(move, path="/Users/biolajohnson/Documents/assignments/561/Homework2/test/play.txt"):
	with open(path, 'w') as f:
		f.write(str(move))

def read_move(path="/Users/biolajohnson/Documents/assignments/561/Homework2/test/play.txt"):
